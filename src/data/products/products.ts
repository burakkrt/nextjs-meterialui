...
const productsData: Array<IProductDatas> = [
  ...
  },
  {
    ...
    category: 'Sulu Söndürme Sistemleri',
    path: '',
    imageUrl: '/images/products/yangin-hidrant-sistemi.jpg',
  ...
  },
  {
    ...
    path: '',
    imageUrl: '/images/products/kopuklu-sprinkler-sistemi.png',
  ...
  },
  {
    ...
    category: 'Köpüklü Söndürme Sistemleri',
    path: '',
    imageUrl: '/images/products/kopuk-monitorleri.png',
  ...
  },
  {
    ...
    path: '',
    imageUrl: '/images/products/fm200-hfc-227ea-sondurme-sistemleri.jpg',
  ...
  },
  {
    ...
    path: '',
    imageUrl:
      '/images/products/novec-1230-fk-5-1-12-sondurme-sistemi.png',
  ...
  },
  {
    ...
    category: 'Temiz Gazlı Söndürme Sistemleri',
    path: '',
    imageUrl: '/images/products/inert-gazli-sondurme-sistemleri.jpg',
  ...
  },
  {
    ...
    path: '',
    imageUrl: '/images/products/kftech-pano-ici-sondurme-sistemi.jpg',
  ...
  },
  {
    ...
    category: 'Davlumbaz Söndürme Sistemleri',
    path: '',
    imageUrl: '/images/products/telli-algilama-sistemi.jpg',
  ...
  },
  {
    ...
    path: '',
    imageUrl: '/images/products/duman-tahliye-kapaklari.jpg',
  ...
  },
  {
    ...
    path: '',
    imageUrl: '/images/products/isg-ekipmanlari.jpg',
  ...
  },
  {
    ...
    path: '',
    imageUrl: '/images/products/yangin-perdesi.jpg',
  ...
  },
  {
    ...
    path: '',
    imageUrl: '/images/products/patlama-guvenlik-ve-kivilcim-algilama.jpg',
  ...
  },
  {
    ...
    path: '',
    imageUrl: '/images/products/yangin-algilama-sistemleri.jpg',
  ...
  },
  {
    ...
    category: 'Yangın ve Gaz Algılama Sistemleri',
    path: '',
    imageUrl: '/images/products/gaz-algilama-sistemi.jpg',
  ...
  },
  {
    ...
    category: 'Yangın Dolapları ve Ekipmanları',
    path: '',
    imageUrl: '/images/products/tek-kapakli-yangin-dolabi.webp',
  ...
  },
  {
    ...
    category: 'Yangın Dolapları ve Ekipmanları',
    path: '',
    imageUrl: '/images/products/sahra-tipi-catili-ayakli-yangin-dolabi.jpg',
  ...
  },
  {
    ...
    category: 'Yangın Dolapları ve Ekipmanları',
    path: '',
    imageUrl: '/images/products/bez-hortumlu-camli-yangin-dolabi.jpg',
  ...
  },
  {
    ...
    category: 'Acil Çıkış Levhaları ve Aydınlatmalar',
    path: '',
    imageUrl: '/images/products/zemin-aydinlatmalari.jpg',
    ...
    categoryEng: ' Emergency Exit Signs and Lightings',
    descEng:
  ...
  },
  {
    ...
    category: 'Acil Çıkış Levhaları ve Aydınlatmalar',
    path: '',
    imageUrl: '/images/products/acil-cikis-levhasi-sol-ok.jpg',
  ...
  },
  {
    ...
    path: '',
    imageUrl: '/images/products/tozlu-portatif-yangin-sonduruculer.png',
  ...
  },
  {
    ...
    category: 'Portatif Yangın Söndürücüler',
    path: '',
    imageUrl: '/images/products/yangin-tupu-312.jpg',
  ...
  },
  {
    ...
    category: 'Portatif Yangın Söndürücüler',
    path: '',
    imageUrl: '/images/products/gazli-portatif-yangin-sonduruculer.jpg',
...
export const categoryPriority: ICategoryPriority = {
  ...
  'Acil Çıkış Levhaları ve Aydınlatmalar': 5,
